(() => {
  ...
  function openRegexDetails(detector){$('regexDetailsTitle').textContent=detector.name;$('regexDetailsPattern').value=detector.pattern;$('regexDetailsSample').value='';const result=$('regexDetailsTestResult');result.textContent='';result.className='test-result';$('regexDetailsDialog').showModal();}
